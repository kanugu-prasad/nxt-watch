In this project, I build **Nxt Watch** 
...
- **Video Item Details Route**
  ...
  - When the **Save** button is clicked,
    - It will change to active state and the respective video details will be added to the list of saved videos
    - **Save** button text will be changed to **Saved**
  - When the **Saved** button is clicked
    - It will change to inactive state and the respective video details will be removed from the list of saved videos
...
- **Header**
  ...
  - When the **Logout** button is clicked, then the [Logout Popup](https://assets.ccbp.in/frontend/content/react-js/nxt-watch-logout-popup-light-theme-lg-output-v0.png) will be displayed
    - When the **Cancel** button is clicked, then the popup will be closed and the page should not be navigated
...
- To build this project, i used Third Party Packages are <a href='https://learning.ccbp.in/frontend-development/course?c_id=2f4192f7-7495-49ca-a6ce-6b74005e25f1&s_id=b01fca1c-aa5c-4d79-b81e-0220e7649bd0&t_id=416f0cab-8425-413b-9157-c7b4d4ae4467' target="_blank">React Popup</a> and <a href='https://learning.ccbp.in/frontend-development/course?c_id=2f4192f7-7495-49ca-a6ce-6b74005e25f1&s_id=b6392b63-25f6-4215-be09-9f23ad91d789&t_id=416f0cab-8425-413b-9157-c7b4d4ae4467' target="_blank">React Video Player</a> 

- To style popup content, I used `.popup-content` class
...
- Used `formatDistanceToNow` function to find the difference between the given date and now in words
...
- Wraped the `Loader` component with an HTML container element and added the `data-testid` attribute value as **loader** to it
...
- The HTML button element with search icon in Home Route will have the `data-testid` attribute value as **searchButton** to it

- **Styled Components** will be used for styling purposes
- The theme icon button will have the `data-testid` as **theme**
- The video thumbnail images in the Routes will have the alt as **video thumbnail**
- The channel logos in Home Route will have the alt as **channel logo**

- **Home Route**

  - The Route will consist of an HTML container element with `data-testid` as **home**
  - The Route will consist of a banner and it contains a close button with `data-testid` as **close**
  - The Route will consist of a banner as shown in the design files with `data-testid` as **banner**
  - The Route will consist of an HTML image element with alt as **nxt watch logo** and src as the given Nxt Watch logo URL in the banner
  - The HTML container element with `data-testid` as **home** will have the background color,
    - If the Light theme is applied, then the **#f9f9f9** color will be applied as a background color
    - If the Dark theme is applied, then the **#181818** color will be applied as a background color

- **Trending Route**

  - The Route will consist of an HTML container element with `data-testid` as **trending**
  - The HTML container element with `data-testid` as **trending** will persist the background color,
    - If the Light theme is applied, then the **#f9f9f9** color will be applied as a background color
    - If the Dark theme is applied, then the **#0f0f0f** color will be applied as a background color

- **Gaming Route**

  - The Route will consist of an HTML container element with `data-testid` as **gaming**
  - The HTML container element with `data-testid` as **gaming** will persist the background color,
    - If the Light theme is applied, then the **#f9f9f9** color will be applied as a background color
    - If the Dark theme is applied, then the **#0f0f0f** color will be applied as a background color

- **Saved Videos Route**

  - The Route will consist of an HTML container element with `data-testid` as **savedVideos**
  - The HTML container element with `data-testid` as **savedVideos** will persist the background color,
    - If the Light theme is applied, then the **#f9f9f9** color will be applied as a background color
    - If the Dark theme is applied, then the **#0f0f0f** color will be applied as a background color

- **Video Item Details Route**

  - The **Video Item Details** Route will consist of an HTML container element with `data-testid` as **videoItemDetails**
  - The HTML container element with `data-testid` as **videoItemDetails** will persist the background color,
    - If the Light theme is applied, then the **#f9f9f9** color should be will as a background color
    - If the Dark theme is applied, then the **#0f0f0f** color should be will as a background color

- The **Website logos** for Light theme and Dark theme will have the alt as **website logo**
- The **Failure** images for Light theme and Dark theme will have the alt as **failure view**
- In the Video Item Details Route, the **#2563eb** color will be applied as `color` for any active button i.e (Like, Dislike, Save)
- In the Video Item Details Route, the **#64748b** color will be applied as `color` for any inactive button i.e (Like, Dislike, Save)
